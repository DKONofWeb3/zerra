 ...
 * sub-navigation for a parent route (currently used for Influence children).
 *
...
/** The Influence sub-nav children — exported so the Sidebar can wire them up. */
export const INFLUENCE_SUB_NAV: SubNavItem[] = [
  {
    to: "/influence/top-creators",
    label: "Top Creators",
    description: "Leaderboards & rankings",
    icon: Users,
  },
  {
    to: "/influence/top-performing",
