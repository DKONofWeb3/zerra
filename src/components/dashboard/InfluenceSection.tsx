...
import type { InfluenceBountyItem } from "@/lib/types";

interface InfluenceSectionProps {
  bounties: InfluenceBountyItem[];
}
...
function BountyEntry({ bounty }: { bounty: InfluenceBountyItem }) {
        ...
        <div className="flex items-center gap-3.5">
          ...
          <div className="leading-tight">
            ...
            <div className="mt-1.5 flex items-center gap-1.5 text-[12.5px] tabular-nums">
              ...
              <span className="text-fg-tertiary">Influence bounty</span>
            </div>
          </div>
        </div>
...
export function InfluenceSection({ bounties }: InfluenceSectionProps) {
  return (
    <div
      className={cn(
